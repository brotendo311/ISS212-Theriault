...
function Detect-Threat {
    ...
    .EXAMPLE
    Detect-Threat -DirectoryPath "/home/juice/ISS/ISS212-Theriault/week5f"
    #>
    param (
        [string]$DirectoryPath,
        [string]$LogFile
...
Detect-Threat -DirectoryPath "/home/juice/ISS/ISS212-Theriault/week5" -LogFile "psSecScript-ioc-log.txt"
